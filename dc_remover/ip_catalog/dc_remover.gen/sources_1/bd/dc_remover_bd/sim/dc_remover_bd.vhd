...
--Command     : generate_target dc_remover_bd.bd
--Design      : dc_remover_bd
...
entity dc_remover_bd is
  ...
  attribute CORE_GENERATION_INFO of dc_remover_bd : entity is "dc_remover_bd,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=dc_remover_bd,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=1,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SYSGEN,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of dc_remover_bd : entity is "dc_remover_bd.hwdef";
end dc_remover_bd;

architecture STRUCTURE of dc_remover_bd is
  component dc_remover_bd_dc_remover_1_0 is
  port (
    sig_in : in STD_LOGIC_VECTOR ( 15 downto 0 );
    clk : in STD_LOGIC;
    sig_out : out STD_LOGIC_VECTOR ( 15 downto 0 )
  );
  end component dc_remover_bd_dc_remover_1_0;
  signal clk_1 : STD_LOGIC;
  signal dc_remover_1_sig_out : STD_LOGIC_VECTOR ( 15 downto 0 );
  signal sig_in_1 : STD_LOGIC_VECTOR ( 15 downto 0 );
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of clk : signal is "xilinx.com:signal:clock:1.0 CLK.CLK CLK";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME CLK.CLK, CLK_DOMAIN dc_remover_bd_clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0";
...
begin
  ...
  sig_out(15 downto 0) <= dc_remover_1_sig_out(15 downto 0);
dc_remover_1: component dc_remover_bd_dc_remover_1_0
     port map (
      clk => clk_1,
